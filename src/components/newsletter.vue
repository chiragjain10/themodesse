<template>
    ...
    <div class="newsletter-popup newsletter-pop1 mfp-hide" id="newsletter-popup"
        ...
        <div class="newsletter-content">
            ...
            <h2 class="font-weight-semi-bold">Sign up to <span>LetSkillify</span></h2>
            <p class="text-grey">Subscribe to the LetSkillify eCommerce newsletter to receive timely updates from your
                favorite
                products.</p>
