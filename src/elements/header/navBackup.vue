    ...
    <nav class="box-navigation">
        <ul class="box-nav-menu">
            ...
            <li class="menu-item dropdown">
                <RouterLink to="/shop" class="item-link">Categories<i class="icon icon-arrow-angle-down"></i>
                </RouterLink>
            ...
            <li class="menu-item dropdown">
                ...
                <div class="dropdown-menu">
                    <ul>
                        <li>
                            <a href="https://www.instagram.com/" class="menu-link-text link" target="_blank" rel="noopener">Instagram Journal</a>
                        </li>
                        <li>
