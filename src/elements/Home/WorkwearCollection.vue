<template>
  <section class="workware-collection-bg">
    <div class="workware-collection-header">
      <h1 class="collection-title">Workwear Collection</h1>
    </div>
...
async function fetchProducts() {
  ...
  try {
    ...
    products.value = (res.workwearCollection || []).map(item => ({
      id: item.id,
      name: item.name,
      price: item.price,
      slug: item.slug,
