<template>
  <section class="Vacation-collection-bg">
    <div class="Vacation-collection-header">
      <h1 class="collection-title">Vacation Collection</h1>
    </div>
...
async function fetchProducts() {
  ...
  try {
    ...
    products.value = (res.vacationCollection || []).map(item => ({
      id: item.id,
      name: item.name,
      price: item.price,
      slug: item.slug,
